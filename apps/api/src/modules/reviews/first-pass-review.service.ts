  ...
  private async processFileReview(input: {
    ...
    try {
      llmResult = await runFirstPassTriage({
        ...
        fallbackApiBase: this.configService.fallbackLlmApiBase,
        fallbackApiKey: this.configService.fallbackLlmApiKey,
        fallbackProvider: this.configService.fallbackLlmProvider,
        fallbackModel: this.configService.fallbackLlmModel,
        promptKind: "triage",
